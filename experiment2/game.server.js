...
game_server.findGame = function(player, debug, test) {
  ...
  if(!joined_a_game) {
    this.createGame(player, debug, test);
  }
};

// Will run when first player connects
game_server.createGame = function(player, debug, test) {
...
game_server.startGame = function(game) {
  ...
  fs.writeFile(game_f, "pid,tick,active,x_pos,y_pos,velocity,angle,bg_val,total_points,obs_bg_val,goal_x,goal_y,on_wall,in_close,in_far,round,round_type,bg_cond,close_cond,vis_file,invis_file,treat_file\n", function (err) {if(err) throw err;})
